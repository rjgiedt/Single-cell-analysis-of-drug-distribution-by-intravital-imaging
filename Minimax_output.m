function [B,T] = Minimax_output(I, iterations, power, Epsilon)
% I: input image
% B: thresholded image
% T: Threshold surface
% implements a line search

Iterations = iterations; % increase if it is inadequate
epsilon=1e-9; % for termination condition, decrease if it is inadequate

pow=power; % although 1 is a pretty good value, 
